...
| **Visão geral**          | O usuário acessa a área de cadastro e depois acessa o módulo de cadastro de rubricas. O sistema verifica se o usuário possui as credenciais para permitir manipulação de rubricas. O usuário insere ou atualiza os dados referentes a rubrica desejada, como rubrica de proventos ou descontos. Revisa-os e, por fim, confirma o cadastro ou atualizaão para o sistema realizar a permanência. |
| **Tipo**                 | Primário e essencial                                                                                                                                                                                                                                                                                              |
...
| **Tipo**                 | Primário e essencial                                                                                                                                                                                                                                                                                              |
| **Referências cruzadas** | Requisitos: 3.1.8.5, 3.1.8.6, 3.1.8.7 — 3.2.5.4 (3.2.5.4.1, 3.2.5.4.2) — 3.3.3.6, 3.3.3.8 — 3.3.8.2, 3.3.8.4 — RN-15                                                                                                            |
...
| **Tipo**                 | Primário e essencial                                                                                                                                  |
| **Referências cruzadas** | Requisitos: 3.1.9.1, 3.1.9.2 (3.1.9.2.1 a 3.1.9.2.7), 3.1.9.5 — 3.2.6.1 (3.2.6.1.1, 3.2.6.1.3) — 3.3.8.3 — RN-15                                                                                                            |
...
| **Referências cruzadas** | Requisitos: 3.1.9.3, 3.1.9.4 — 3.2.6.1.2, 3.2.6.1.3 — 3.3.1.4 — 3.3.2.3.4 — RN-15      |
...
| **Tipo**                 | Secundário e Opcional      |
| **Referências cruzadas** | Requisitos: 3.2.6.2 (3.2.6.2.1, 3.2.6.2.2) — 3.2.6.3 (3.2.6.3.1) — 3.3.8.6 — RN-15      |
...
| **Tipo**                 | Secundário e Opcional      |
| **Referências cruzadas** | Requisitos: 3.1.10.1, 3.1.10.2, 3.1.10.3, 3.1.10.4, 3.1.10.5 — 3.2.6.4 (3.2.6.4.1, 3.2.6.4.2, 3.2.6.4.3) — 3.3.8.4 — RN-15     |
...
| **Atores**               | RH / Administrador (iniciador)         |
| **Finalidade**           | O usuário pode atualizar alíquotas e tabelas legais sem precisar recompilar o sistema.                                            |
| **Visão geral**          | O usuário acessa o módulo de cadastro da empresa. O sistema deve verificar se o usuário tem permissão. Caso esteja em conformidade, o usuário pode realizar a alteração das alíquotas e tabelas legais, como: INSS, piso salarial e FGTS, sem a necessidade de recompilar o sistema. |
| **Tipo**                 | Primário e Opcional      |
| **Referências cruzadas** | Requisitos: 3.2.1.5 (3.2.1.5.1, 3.2.1.5.2) — 3.3.6.2 — 3.3.8.1, 3.3.8.5 — RN-01, RN-09     |  
