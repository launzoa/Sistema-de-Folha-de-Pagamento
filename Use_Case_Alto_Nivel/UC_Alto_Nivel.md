...
| UC-08 | Cadastro de Rubricas             | RH / Administrador      | Primário   | Cadastra e personaliza rubricas de proventos e descontos com suas incidências.            |
...
| UC-17 | Atualização de Parâmetros Legais | RH / Administrador      | Primário   | Atualiza alíquotas e tabelas legais (INSS, piso salarial, FGTS) sem recompilar o sistema. |
