...
**RFF-05 — Cadastrar funcionário**

* RFF-05.01 — O sistema deve receber corretamente os dados cadastrais do funcionário: nome, cpf, data de adimissão, cargo, salário bruto, status.
* RFF-05.02 — O sistema deve validar o cpf do funcionário para evitar duplicidade de cadastro, bem como validar se o cpf é considerado válido.
* RFF-05.03 — O sistema deve validar se o status é válido.

**RFF-06 — Parâmetros Legais**

* RFF-06.01 — O sistema deve permitir o cadastro de parâmetros legais.
* RFF-06.02 — O sistema deve permitir o cadastro de faixas de valores para cálculo de INSS.
* RFF-06.03 — O sistema deve permitir o cadastro de valores de hora extra por tipo.
* RFF-06.04 — O sistema deve permitir o cadastro de valores de dias úteis e dias trabalhados.
* RFF-06.05 — O sistema deve permitir atualizar os parâmetros legais.
...
**RFU-02 — Tela de cadastro de funcionário**
RFU-02.01 — O sistema deve apresentar uma interface gráfica para o cadastro de funcionário.
