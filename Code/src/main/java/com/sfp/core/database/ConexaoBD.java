 ...
 *        Sendo chamado apenas quando preciso fazer uma alteração ou consulta ao BD.
 */
...
public class ConexaoBD {
    // Variáveis obtidas por ambiente (Environment Variables) ou fallback para padrões
    private static final String URL = System.getenv("DB_URL") != null ? System.getenv("DB_URL") : "jdbc:mysql://localhost:3306/SFP";
